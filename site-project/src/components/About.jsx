...
const About = () => {
  return (
    <div name="about" className="w-full h-screen bg-gray-400 text-[#0a192f]">
      <div className="flex flex-col justify-center items-center w-full h-full">
        ...
        <div className="max-w-[1000px] w-full grid sm:grid-cols-2 gap-8 px-4">
          <div className="sm:text-right text-4xl font-bold">
            <p>
              Hi. I'm Shubhangi, nice to meet you. Please take a look around.
            </p>
          </div>
          <div>
            <p>
              I'm passionate about building excellent software that improves the
              lives of those around me. I specialize in creating software fro
